...
title: GameCoreEvent.UnitJumped
---
# GameCoreEvent.UnitJumped
...
## Usage
> [!EXAMPLE] Example
> **GameEvents.UnitJumped**(  )

UnitJumped exists in GameEvents. It doesn't exist in Events.
**Firaxis has never used UnitJumped in its Lua scripts.**
