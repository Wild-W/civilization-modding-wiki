...
tags:
- Events/SerialEvent
title: SerialEvent.BeginMainMenu
---
# SerialEvent.BeginMainMenu
...
## Usage
> [!EXAMPLE] Example
> **GameEvents.BeginMainMenu**(  )

BeginMainMenu exists in GameEvents. It doesn't exist in Events.
**Firaxis has never used BeginMainMenu in its Lua scripts.**
