...
title: GameCoreEvent.StormAddedToMap
---
# GameCoreEvent.StormAddedToMap
...
StormAddedToMap exists in GameEvents. It also exists in Events.
**Firaxis has never used StormAddedToMap in its Lua scripts.**
