...
title: GameCoreEvent.DroughtAddedToMap
---
# GameCoreEvent.DroughtAddedToMap
...
DroughtAddedToMap exists in GameEvents. It also exists in Events.
**Firaxis has never used DroughtAddedToMap in its Lua scripts.**
