...
title: GameCoreEvent.GamePropertyChanged
---
# GameCoreEvent.GamePropertyChanged
...
GamePropertyChanged exists in GameEvents. It also exists in Events.
**Firaxis has never used GamePropertyChanged in its Lua scripts.**
